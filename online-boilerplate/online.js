...
const ONLINE_CONFIG = {
  SESSION_KEY: 'board-game-online',   // localStorage 键名，不同游戏用不同值
  GAME_TITLE: '桌游',                  // 游戏名称
};
 ...
 */
const HOOK_dealGame = null; // → function(names: string[]): void
 ...
 * 示例：function() { render(); }
 */
const HOOK_render = null; // → function(): void
 ...
 */
const HOOK_renderLanding = null; // → function(): string
 ...
 */
const HOOK_clearState = null; // → function(): void
 ...
 */
const HOOK_addLog = null; // → function(msg: string, cls?: string): void
 ...
 */
const HOOK_showEndModal = null; // → function(): void
 ...
 */
const HOOK_getPlayers = null; // → function(): Array<{name: string, ...}>
 ...
 */
const HOOK_getCurrentPlayer = null; // → function(): number
 ...
 */
const HOOK_getPlayerColors = null; // → function(): string[]
